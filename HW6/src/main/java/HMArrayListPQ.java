 ...
 *//*
public class HMArrayListPQ<E> implements IntHMPriorityQueue<E> , Serializable {

	private Comparator<E> comparator;
	private ArrayList<E> data;

	public HMArrayListPQ(int size, Comparator<E> comparator) {
...
public class HMArrayListPQ < E > implements IntHMPriorityQueue < E > {
	 ...
	 */
	public HMArrayListPQ(Comparator < E > comp) {
