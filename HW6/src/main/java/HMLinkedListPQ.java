...
public class HMLinkedListPQ<E> implements IntHMPriorityQueue<E>, Serializable {
	 ...
	 */
	public HMLinkedListPQ(Comparator<E> comp) {
	...
	/* ANOTHER TEST ALGRITH - DON'T TOUCH IT
	private Comparator<E> comparator;
	private LinkedList<E> data;

	public HMLinkedListPQ(Comparator<E> comparator) {
		data = new LinkedList<>();
